<?php 
global $display2;$display5;$display4;$display;
$connect=mysqli_connect ("localhost","kala","kala","almond");
if(isset($_POST["see"])){
    // echo $_POST['see'];
    $search = $_POST['see'];
		$get=mysqli_query($connect,"SELECT * FROM  shipment where tracking_number='$search'");
       ...
       while($rows=mysqli_fetch_array($get)){
        ...
        <div class='col-sm-6'>
          <div class='card'>
            ...
            <p class='card-text'>
              <span style='color:chocolate; font-weight:bolder'>NAME:</span> $rows[shipper_name] <br> 
              <span style='color:chocolate; font-weight:bolder'>ADDRESS:</span> $rows[shipper_address]<br>
              <span style='color:chocolate; font-weight:bolder'>PHONE:</span> $rows[shipper_phone]
        ...
        $display="<center><div class='alert alert-danger'>No Result Found <a href='index.php'>Click Here</a> and search again</div>";
      }
  }
	...
	if(isset($_POST["see"])){
		// echo $_POST['see'];
    $search = $_POST['see'];
		$get2=mysqli_query($connect,"SELECT * FROM  shipment where tracking_number='$search'");
        ...
        <div class='col-sm-6'>
          <div class='card'>
            ...
            <p class='card-text'>
              <span style='color:chocolate; font-weight:bolder'>NAME:</span> $row[receiver_name] <br> 
              <span style='color:chocolate; font-weight:bolder'>ADDRESS:</span> $row[receiver_address] <br>
              <span style='color:chocolate; font-weight:bolder'>PHONE:</span> $row[receiver_phone]
			...
			$display2="<center><div class='alert alert-danger'>No Result Found <a href='index.php'>Click Here</a> and search again</div>";
		}
	...
	if(isset($_POST["see"])){
		// echo $_POST['see'];
    $search = $_POST['see'];
		$get4=mysqli_query($connect,"SELECT * FROM  status where tracking_number='$search'");
		if(mysqli_num_rows($get4)>0){
			$display4="
		...
		$display4.="
			...
			$display4="<center><div class='alert alert-danger'>No Result Found <a href='index.php'>Click Here</a> and search again</div>";
		}
	...
	if(isset($_POST["see"])){
		// echo $_POST['see'];
    $search = $_POST['see'];
		$get5=mysqli_query($connect,"SELECT * FROM  shipment where tracking_number='$search'");
		if(mysqli_num_rows($get5)>0){
       while($rowd=mysqli_fetch_array($get5)){
			  $display5="
          <div class='col-6'>
            <div class='card text-center'>
              ...
              <p class='card-text'>
                  <span style='color:chocolate; font-weight:bolder'>TRACKING NUMBER:</span> $rowd[tracking_number] <br> 
                  <span style='color:chocolate; font-weight:bolder'>PACKAGE NAME:</span> $rowd[description] <br>
                  <span style='color:chocolate; font-weight:bolder'>PACKAGE DESCRIPTION:</span> $rowd[description] <br>
                  <span style='color:chocolate; font-weight:bolder'>SHIPMENT WEIGHT</span> $rowd[weight] <br>
                  <span style='color:chocolate; font-weight:bolder'>SHIPPED DATE</span> $rowd[shipment_date] <br>
                  <span style='color:chocolate; font-weight:bolder'>ESTIMATED DELIVERY DATE:</span> $rowd[shipment_delivery] <br>
                  <span style='color:chocolate; font-weight:bolder'>SHIPMENT MODE:</span> $rowd[shipment_mode] <br>
                  <span style='color:chocolate; font-weight:bolder'>SHIPMENT CLASS</span> $rowd[shipment_type] <br>
                  <span style='color:chocolate; font-weight:bolder'>SHIPMENT AGENT</span> $rowd[shipment_agent]<br>
                  <span style='color:chocolate; font-weight:bolder'>SHIPMENT ORIGIN</span> $rowd[shipment_origin]<br>
                  <span style='color:chocolate; font-weight:bolder'>SHIPMENT DESTINATION</span> $rowd[shipment_destination]<br>
              </p>
              </div>
            </div> 
          </div>";
			...
			$display5="<center><div class='alert alert-danger'>No Result Found <a href='index.php'>Click Here</a> and search again</div>";
		}
            ...
            <div class="tracking-area pt-95 pb-115">
                <div class="container">
                    <div class="row justify-content-center">
                        <div class="col-xl-8 col-lg-10">
                            <div class="tracking-id-info text-center">
                                ...
                                <form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="POST" class="tracking-id-form">
                                    <input type="text" name="see" placeholder="Tracking id">
                    ...
                    <?php
                        if(isset($_POST["see"])){
                            $search = $_POST['see'];
                            $get1=mysqli_query($connect,"SELECT * FROM  status where tracking_number='$search' ORDER BY status_id DESC LIMIT 0,1");
                            if(mysqli_num_rows($get1)>0){
                              while($row1=mysqli_fetch_array($get1)){
                                $progress = $row1['progress'];
                    ?>
									  <div class="progress-bar progress-bar-striped progress-bar-animated" role="progressbar" aria-valuenow="75" aria-valuemin="0" aria-valuemax="100" style="width: <?php echo $progress;?>%"><?php echo $progress;?>%</div>
                  ...
                  <div class="tracking-list">
                      <ul>
                        ...
                        <?php } else { ?>
                          ...
                          <?php } if(($progress > 25) && ($progress < 51)){?>
                            <li class="active">
                              <div class="tracking-list-icon bg-warning border-warning">
                                  <i class="flaticon-warehouse"></i>
                              </div>
                              <div class="tracking-list-content">
                                  <p class="text-warning">Dispatched</p>
                              </div>
                            </li>
                          <?php } else { ?>
                            <li>
                          ...
                          </li><?php }if(($progress > 50) && ($progress < 99)){ ?>

                          <li class="active">
                              <div class="tracking-list-icon bg-info border-info">
                                  <i class="flaticon-placeholder"></i>
                              </div>
                              <div class="tracking-list-content">
                                  <p class="text-info">In transit</p>
                              </div>
                          </li>
                          <?php } else { ?>
                            <li class="">
                          ...
                          <?php } if($progress == 100){ ?>
                          <li class="active">
                              <div class="tracking-list-icon bg-success border-success">
								...
								<hr>
								 ...
								 <div class="tracking-list">
                                    <div class="row">
										...
										<div class="col-sm-6">
										<div class="card">
                      <div class="card-header"><h5 class="card-title">PACKAGE IMAGE</h5></div>
										  <div class="card-body">
											<div class="panel">
                        <?php
                          if(isset($_POST['see'])){
                        ...
                        ?>
                        <img src="admin/dashboard/upload/<?php echo $photo;?>"
                          class="rounded img-responsive" style="width:280px; height:250px;" />
                                <?php echo $photo;?>
                        <?php
                              }
                            }
